...
echo -e "*\033[0;33mTiming and area constraints have not yet been determined!\033[0m"
echo -e "\033[0;33mThey will be incorporated into the synthesis checks soon!\033[0m"
exit 0
